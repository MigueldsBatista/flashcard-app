    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50 dark:bg-slate-900">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white dark:bg-slate-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100 dark:border-slate-700">
                <div v-if="successMessage" class="rounded-md bg-green-50 dark:bg-green-900/50 p-4 mb-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <router-link to="/login" class="text-sm font-medium text-green-800 hover:text-green-700 dark:text-green-200 dark:hover:text-green-100 underline">
                                    Go to Sign in
                                </router-link>
                            </div>
                        </div>
