  ...
  <div class="min-h-screen bg-background p-4 pb-24 md:pb-8">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="mb-6 flex items-center gap-3">
        <Button variant="ghost" size="sm" class="p-2" @click="router.push('/')">
      ...
      <Card class="p-4 sm:p-6">
        <!-- Tabs -->
        <Tabs v-model="activeTab" :tabs="inputTabs">
          <template #default="{ activeTab: tab }">
            <!-- Image Upload Tab -->
            <div v-if="tab === 'image'" class="space-y-4">
              <div
                v-if="!imagePreview"
            ...
            <!-- Text Input Tab -->
            <div v-if="tab === 'text'" class="space-y-4">
              <div>
                <label class="text-sm font-medium text-muted-foreground mb-1.5 block">
      ...
      <!-- Preview Dialog -->
      <Dialog :open="showPreview" @update:open="(v) => !v && closePreview()">
        <template #default>
          <div class="space-y-4 max-h-[80vh] overflow-y-auto">
            <div class="flex items-center justify-between sticky top-0 bg-card pb-2 border-b border-border -mx-6 px-6 -mt-6 pt-6">
              ...
              <div class="flex gap-2">
                <Button variant="ghost" size="sm" @click="selectAllCards">
                  Selecionar todos
                </Button>
                <Button variant="ghost" size="sm" @click="deselectAllCards">
                  Limpar
                </Button>
              </div>
            </div>
            ...
            <div class="space-y-3">
              ...
              >
                <div class="flex items-start gap-3">
                  ...
                  >
                    <Check v-if="card.selected" class="w-4 h-4" />
            ...
            <div class="flex flex-col-reverse sm:flex-row gap-2 sticky bottom-0 bg-card pt-4 border-t border-border -mx-6 px-6 -mb-6 pb-6">
              <Button variant="outline" class="flex-1" @click="closePreview" :disabled="isSaving">
                Cancelar
              </Button>
              <Button
